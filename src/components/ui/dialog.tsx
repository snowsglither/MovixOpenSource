...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Overlay
        ...
        data-lenis-prevent
        className={cn(
            "fixed inset-0 z-[100000] bg-black/80 backdrop-blur-sm",
    ...
    return (
        <DialogPortal>
            ...
            <DialogPrimitive.Content
                ...
                data-lenis-prevent
                className={cn(
                    "fixed left-[50%] top-[50%] z-[100001] grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-white/10 bg-gray-900/95 p-6 shadow-2xl backdrop-blur-md rounded-xl",
